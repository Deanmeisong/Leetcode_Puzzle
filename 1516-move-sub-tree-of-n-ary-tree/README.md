<h2><a href="https://leetcode.com/problems/move-sub-tree-of-n-ary-tree/">1516. Move Sub-Tree of N-Ary Tree</a></h2><h3>Hard</h3><hr><div><p>Given the <code>root</code> of an <span data-keyword="n-ary-tree">N-ary tree</span> of unique values, and two nodes of the tree <code>p</code> and <code>q</code>.</p>
...
<pre><strong>Input:</strong> root = [1,null,2,3,null,4,5,null,6,null,7,8], p = 4, q = 1
...
<pre><strong>Input:</strong> root = [1,null,2,3,null,4,5,null,6,null,7,8], p = 7, q = 4
...
<pre><strong>Input:</strong> root = [1,null,2,3,null,4,5,null,6,null,7,8], p = 3, q = 8
