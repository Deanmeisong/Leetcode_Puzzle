...
//         if(a + b > n + 1) return dp(n, n + 1 - a, n + 1 - b);
        
//         int range1 = a - 1; int range2; int half_point = (n + 1) / 2; int bb = n + 1 - b;
...
//             int mid = b - bb - 1;
//             for(int x = 0; x <= a - 1; ++x)
//                 for(int y = a + 1; y <= bb - 1; ++y) {
//                     auto tmp = dp(n / 2, x + 1, y + (mid + 1) / 2 + x + 2);
...
//         }
    ...
    vector<int> earliestAndLatest(int n, int firstPlayer, int secondPlayer) {
        ...
        // auto [first, second] = dp(n, firstPlayer, secondPlayer);
        // return {first, second};
    }
};